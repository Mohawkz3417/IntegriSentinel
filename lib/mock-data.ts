...
export const mockAlerts = [
  { id: "ALT-001", timestamp: "2026-03-02T14:25:00Z", device: "CSE-LAB-PC03", type: "Brute Force Attempt", severity: "critical", description: "15 failed login attempts detected in 2 minutes", status: "open" },
  { id: "ALT-002", timestamp: "2026-03-02T14:20:00Z", device: "CSE-LAB-PC02", type: "Firewall Disabled", severity: "high", description: "Windows Firewall has been disabled on this device", status: "investigating" },
  { id: "ALT-003", timestamp: "2026-03-02T14:15:00Z", device: "LIB-PC01", type: "Malicious Hash Detected", severity: "critical", description: "File matches known malicious hash: 5d41402abc4b2a76b971...", status: "open" },
  { id: "ALT-004", timestamp: "2026-03-02T13:50:00Z", device: "CSE-LAB-PC03", type: "Unauthorized Driver", severity: "high", description: "New unsigned driver installed: USBMon.sys", status: "open" },
  { id: "ALT-005", timestamp: "2026-03-02T13:30:00Z", device: "HR-PC01", type: "After Hours Login", severity: "medium", description: "Login detected at 02:15 AM outside business hours", status: "resolved" },
  { id: "ALT-006", timestamp: "2026-03-02T13:10:00Z", device: "MECH-LAB-PC01", type: "Suspicious Port", severity: "medium", description: "Port 4444 detected open - commonly used by exploits", status: "investigating" },
  { id: "ALT-007", timestamp: "2026-03-02T12:45:00Z", device: "ECE-LAB-PC01", type: "Antivirus Disabled", severity: "high", description: "No antivirus detected on endpoint", status: "open" },
  { id: "ALT-008", timestamp: "2026-03-02T12:30:00Z", device: "CSE-LAB-PC01", type: "USB Device", severity: "low", description: "Unknown USB device connected: Kingston DT", status: "resolved" },
  { id: "ALT-009", timestamp: "2026-03-02T11:15:00Z", device: "FINANCE-PC01", type: "File Modification", severity: "medium", description: "Critical file modified: C:\\Windows\\System32\\config\\SAM", status: "investigating" },
  { id: "ALT-010", timestamp: "2026-03-02T10:00:00Z", device: "ADMIN-PC01", type: "Outdated OS", severity: "low", description: "Operating system version is outdated: Win10 22H2", status: "open" },
]
